...
Learned how to structure a blog page that shows all new posts dynamically by using markdown files and collections in Astro.js, where the blog posts are stored inside a content/blog folder.
